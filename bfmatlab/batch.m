...
%         dates{end+1} = ['F:\',flashFiles(f).name];
%     end
% end
% 
...
%         expsFolder = 'F:\Experiments_Fluo-8';
%         cellFolder = 'F:\Cells_Fluo-8';
%     else
%         expsFolder = 'F:\Experiments_Rhod-2';
%         cellFolder = 'F:\Cells_Rhod-2';
%     end
...
cellsFolderPath = 'F:\Cells_Fluo-8';
% cellsFolderPath = 'F:\Cells_Rhod-2';
...
count = 1;
cellInfo = cell(1,26);
expObjectPath = 'F:\Experiments_Fluo-8';
% expObjectPath = 'F:\Experiments_Rhod-2';
