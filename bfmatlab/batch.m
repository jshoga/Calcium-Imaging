...
numPeaksSpontGroup = cell(numGroups,1);
heightSpontGroup = cell(numGroups,1);
promSpontGroup = cell(numGroups,1);
widthSpontGroup = cell(numGroups,1);
riseSpontGroup = cell(numGroups,1);
fallSpontGroup = cell(numGroups,1);

numPeaksTreatGroup = cell(numGroups,1);
heightTreatGroup = cell(numGroups,1);
promTreatGroup = cell(numGroups,1);
widthTreatGroup = cell(numGroups,1);
riseTreatGroup = cell(numGroups,1);
fallTreatGroup = cell(numGroups,1);

numActive = zeros(numGroups,1);
numCellsTotal = zeros(numGroups,1);
