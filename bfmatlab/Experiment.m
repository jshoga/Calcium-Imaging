classdef Experiment
    ...
    methods
        function obj = Experiment(filepath,images,mask)
            if nargin == 1
                % Choose experiment file
                experimentFile = bfopen(filepath);
                % Save images to imageSequence variable
                imageSequence = experimentFile{1};
                % Relic fix this:
            ...
            dateIdx = regexp(filepath,'2015');
            obj.date = filepath(dateIdx:dateIdx+9);
            obj.images = regSequence;
            obj.expNo = str2double(filepath(dateIdx+11:dateIdx+12));
            if obj.expNo == 1 || ...
                    obj.expNo == 2 || ...
                    obj.expNo == 3 || ...
                    obj.expNo == 4 || ... 
